...
export default function RecipeReviewCard(props) {
  ...
  return (
    <Card className={classes.root}>
      ...
      <button className='resbutton' type="submit" onClick={adddish}>Order</button>
        <IconButton
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography paragraph>
            <ul>
            {props.ingredient.map((ingredient,index) => (<p className="leftGap"><li key={index}>{ingredient}</li></p>))}
            </ul>
          </Typography>
        </CardContent>
      </Collapse>
